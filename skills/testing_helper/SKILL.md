---
name: testing-helper
description: Generates and runs unit tests, integration tests, and test strategies; supports mocking, failure analysis, and coverage improvement. 支持生成并运行测试、分析失败和改进覆盖率。
triggers:
  - test
  - unit test
  - integration test
